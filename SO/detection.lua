...
local function didTheyHearThat()
        ...
        for _,actor in pairs(mobileActors) do
            ...
            if actor == mobilePlayer then goto continue end
            ...
            if wasHeard then
                ...
                investigation.startTravel(actor.reference,playerPosition)
...
local function onAddSound(e)
    ...
    if footStepName[id] then
        ...
        if chance < config.stepTriggerChance then didTheyHearThat() end
    end
end
